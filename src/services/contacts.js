...
export const getAllContact = async (page, perPage, sortBy='_id', sortOrder=SORT_ORDER.ASC, filter={}) => {
    const limit = perPage;
    ...
    const paginationData = calculatePaginationData(contactsCounts, page, perPage);
